...
void MX_FREERTOS_Init(void)
{
    ...
    LCDDisplayTaskHandle = osThreadNew(StartLCDDisplayTaskFunction, &NowTime, &LCDDisplayTask_attributes);
    ...
    TimeSetTaskHandle = osThreadNew(StartTimeSetTaskFunction, &NowTime, &TimeSetTask_attributes);
